...
public class RoomRpc {
	...
	/**
	 * 修改房间状态 id 房间id roomStatus 房间状态
	 */
	...
	/**
	 * 讯/询问室列表 roomtype 房间类型 为空，则代表查询除等候室之外的所有房间 roomstatus 房间状态 为空，则代表查询所有
	 */
	...
	/**
	 * 讯/询问室分配,手动分配 registerId 注册人员id id 房间id
	 */
	...
	/**
	 * 等候室分派 ，直接分配，不考虑预警规则 registerId 人员id 房间id id
	 */
	 ...
	 */
	@RequestMapping("/checkRoomWaitDistribution")
	public ActionResult<String> checkRoomWaitDistribution(Long registerId, Long roomId) {
		return roomPropertyService.checkRoomWaitDistribution(registerId, roomId);
	}
}
