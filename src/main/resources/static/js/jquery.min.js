...
// Give the init function the jQuery prototype for later instantiation
    ...
    jQuery.extend({
                      ...
                      // created in this context, defaults to document scripts
                      // (optional): If true, will include scripts passed in
                      // the html string
                      parseHTML: function (data, context, scripts) {
                          ...
                          parsed =
                              jQuery.buildFragment([data], context,
                                                   scripts ? null : []);
                          return jQuery.merge([],
                                              (parsed.cacheable ? jQuery.clone(
                                                  parsed.fragment)
                      ...
                      each: function (obj, callback, args) {
                          ...
                          if (args) {
                              if (isObj) {
                                  for (name in obj) {
                                      if (callback.apply(obj[name], args)
                                          === false) {
                                          break;
                                      }
                                  }
                      ...
                      makeArray: function (arr, results) {
                          ...
                          if (arr != null) {
                              ...
                              // 'length' Tweaked logic slightly to handle
                      ...
                      // collection The value/s can optionally be executed if
                      // it's a function
                      access: function (elems, fn, key, value, chainable,
                          ...
                          if (key && typeof key === "object") {
                              ...
                              // exec is true
                              exec =
                                  pass === undefined && jQuery.isFunction(
                                  value);
                          ...
                          return chainable ? elems : // Gets
                                 bulk ? fn.call(elems) : length ? fn(elems[0],
                                                                     key)
                                     : emptyGet;
                      },
 ...
 */
    ...
    jQuery.support = (function () {
        ...
        support = {
            ...
            // selected property. (WebKit defaults to false instead of true, IE
            // too, if it's in an optgroup)
        ...
        // We only care about the case where non-standard event systems are
        // used, namely in IE. Short-circuiting here helps us to avoid an eval
        // call (in setAttribute) which can cause CSP to go haywire. See:
        ...
        jQuery(function () {
            ...
            // information). (only IE 8 fails this test)
            ...
            if (window.getComputedStyle) {
                ...
                // incorrectly gets computed margin-right based on width of
                // container. For more info see bug #3333 Fails in WebKit
                // before Feb 2011 nightlies WebKit Bug 13343 -
    ...
    jQuery.extend({
                      ...
                      data: function (elem, name, data, pvt
                          ...
                          var thisCache, ret,
                              ...
                              // differently because IE6-7 can't GC object
                              // references properly across the DOM-JS boundary
                              isNode = elem.nodeType,

                              // Only DOM nodes need the global jQuery cache;
                              // JS object data is attached directly to the
                              // object so GC can occur automatically
                              cache = isNode ? jQuery.cache : elem,

                              // Only defining an ID for JS objects if its
                              // cache already exists allows the code to
                              // shortcut on the same path as a DOM node with
                              // no cache
                              id = isNode ? elem[internalKey]
                                  : elem[internalKey] && internalKey;

                          // Avoid doing any more work than we need to when
                          // trying to get data on an object that has no data
                          // at all
                          ...
                          if (!id) {
                              ...
                              // element since their data ends up in the global
                              // cache
                              if (isNode) {
                                  elem[internalKey] =
                                      id =
                                          jQuery.deletedIds.pop()
                                          || jQuery.guid++;
                              } else {
                                  id = internalKey;
                              }
                          ...
                          if (!cache[id]) {
                              ...
                              // objects when the object is serialized using
                              // JSON.stringify
                              if (!isNode) {
                          ...
                          // a key/value pair; this gets shallow copied over
                          // onto the existing cache
                          ...
                          // inside the object's internal data cache in order
                          // to avoid key collisions between internal data and
                          // user-defined data.
                          if (!pvt) {
                              if (!thisCache.data) {
                                  thisCache.data = {};
                          ...
                          // non-converted data property names If a data
                      ...
                      removeData: function (elem, name, pvt
                          ...
                          // object, there is no purpose in continuing
                          if (!cache[id]) {
                              return;
                          }
                          ...
                          if (name) {
                              ...
                              if (thisCache) {
                                  ...
                                  // want to continue and let the cache object
                                  // itself get destroyed
                          ...
                          if (!pvt) {
                              ...
                              // internal data object had been the only thing
                              // left in it
                          ...
                          } else if (jQuery.support.deleteExpando || cache
                                                                     != cache.window) {
                              delete cache[id];
    ...
    jQuery.fn.extend({
                         data: function (key, value) {
                             ...
                             return jQuery.access(this, function (value) {
                                 ...
                                 if (value === undefined) {
                                     data =
                                         this.triggerHandler("getData" + part,
                                             [parts[0]]);
                                 ...
                                 this.each(function () {
                                     ...
                                     self.triggerHandler("setData" + part,
                                         parts);
                                     jQuery.data(this, key, value);
                                     self.triggerHandler("changeData" + part,
                                         parts);
                                 });
...
// checks a cache object for emptiness
    ...
    jQuery.fn.extend({
                         ...
                         delay: function (time, type) {
                             time =
                                 jQuery.fx ? jQuery.fx.speeds[time] || time
                                     : time;
                             type = type || "fx";
    ...
    jQuery.extend({
                      valHooks: {
                          option: {
                              get: function (elem) {
                                  ...
                                  // Blackberry 4.7 but uses .value. See #6932
                      ...
                      attr: function (elem, name, value, pass) {
                          ...
                          if (notxml) {
                              ...
                              hooks =
                                  jQuery.attrHooks[name] || ( rboolean.test(
                          ...
                          type: {
                              set: function (elem, value) {
                                  ...
                                  if (rtype.test(elem.nodeName)
                                      ...
                                      // IE6-9 Reset value to it's default in
                                      // case type is set after value This is
    ...
    boolHook = {
        ...
        set: function (elem, value, name) {
            ...
            if (value === false) {
                ...
                // and not false Set boolean attributes to the same name and
    ...
    if (!jQuery.support.checkOn) {
        jQuery.each(["radio", "checkbox"], function () {
            jQuery.valHooks[this] = {
                get: function (elem) {
                    // Handle the case where in Webkit "" is returned instead
                    // of "on" if a value isn't specified
    ...
    jQuery.event = {
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
            ...
            for (t = 0; t < types.length; t++) {
                ...
                namespaces =
                    namespaces ? new RegExp("(^|\\.)" + namespaces.split(".")
                        .sort().join("\\.(?:.*\\.|)") + "(\\.|$)") : null;
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            var cache, exclusive, i, cur, old, ontype, special, handle,
            ...
            if (!onlyHandlers && !special.noBubble && !jQuery.isWindow(elem)) {
                ...
                cur =
                    rfocusMorph.test(bubbleType + type) ? elem
                        : elem.parentNode;
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(
                    ...
                    // (#6170) IE<9 dies on focus/blur to hidden element
                    // (#1486)
                    if (ontype && elem[type] && ((type !== "focus" && type
                                                  !== "blur")
        ...
        dispatch: function (event) {
            ...
            for (i = 0;
                ...
                for (j = 0; j < matched.matches.length
                    ...
                    // no namespace, or 2) have namespace(s) a subset or equal
                    // to those in the bound event (both can have no
                    // namespace).
...
// Create "bubbling" focus and blur events
    ...
    jQuery.fn.extend({
                         ...
                         toggle: function (fn) {
                             // Save reference to arguments for access in
                             // closure
                             var args = arguments,
                                 ...
                                 toggler = function (event) {
                                     ...
                                     var lastToggle = ( jQuery._data(
                                         this, "lastToggle" + fn.guid) || 0 )
                                                      % i;
                             ...
                             // link all the functions, so any of them can
    ...
    (function (window, undefined) {
        ...
        var cachedruns,
            ...
            matchExpr = {
                ...
                "needsContext": new RegExp("^" + whitespace + "*[>+~]|" + pos,
                    "i")
            },
            ...
            assertUsableName = assert(function (div) {
                ...
                div.id = expando + 0;
                div.innerHTML =
                    "<a name='" + expando + "'></a><div name='" + expando
                    + "'></div>";
                docElem.insertBefore(div, docElem.firstChild);

                // Test
                var pass = document.getElementsByName &&
                           // buggy browsers will return fewer than the correct
                           // 2
                    ...
                    if ((m = match[1])) {
                        if (nodeType === 9) {
                            ...
                            if (elem && elem.parentNode) {
                                ...
                                // return items by name instead of ID
                                if (elem.id === m) {
                                    results.push(elem);
                                    return results;
                                }
        ...
        Expr = Sizzle.selectors = {
            ...
            find: {
                "ID": assertGetIdNotName ? function (id, context, xml) {
                    ...
                    if (typeof context.getElementById !== strundefined
                        ...
                        return m ? m.id === id || typeof m.getAttributeNode
                                                  !== strundefined
                                                  && m.getAttributeNode(
                            "id").value === id ? [m] : undefined : [];
                    }
                },
                ...
                "CLASS": assertUsableClassName && function (className, context,
                                                            xml) {
			...
			*/
                    ...
                    if (match[1] === "nth") {
                        ...
                        match[3] =
                            +( match[3] ? match[4] + (match[5] || 1) : 2
                                                                       * ( match[2]
                                                                           === "even"
                                                                           || match[2]
                                                                           === "odd" ) );
                        match[4] =
                            +( ( match[6] + match[7] ) || match[2] === "odd" );
            ...
            filter: {
                ...
                "CLASS": function (className) {
                    ...
                    return pattern ||
                           (pattern =
                               new RegExp("(^|" + whitespace + ")" + className
                                          + "(" + whitespace + "|$)")) &&
                    ...
                    return function (elem, context) {
                        ...
                        return operator === "=" ? result === check : operator
                            ...
                            ? result !== check : operator === "^=" ? check
                                                                     && result.indexOf(
                                    check) === 0 : operator === "*=" ? check
                                                                       && result.indexOf(
                                    check) > -1 : operator === "$=" ? check
                ...
                "PSEUDO": function (pseudo, argument) {
                    ...
                    // Prioritize by case sensitivity in case custom pseudos
                    // are added with uppercase letters Remember that
            ...
            pseudos: {
                ...
                "empty": function (elem) {
                    ...
                    // nodes(including text(3), cdata(4)), not comment,
                    // processing instructions, or others Thanks to Diego
                    // Perini for the nodeName shortcut Greater than "@" means
                    // alpha characters (specifically not starting with "#" or
                    // "?")
                    var nodeType;
                ...
                "text": function (elem) {
                    ...
                    // types (search, etc) use getAttribute instead to test
                    // this case
...
// Document sorting and removing duplicates
            ...
            return markFunction(function (seed, results, context, xml) {
                var temp, i, elem,
                    ...
                    matcherIn = preFilter && ( seed || !selector ) ? condense(
                        elems, preMap, preFilter, context, xml) : elems,
        ...
        compile =
            Sizzle.compile =
                function (selector, group /* Internal Use Only */) {
                    var i,
                        setMatchers = [],
                        elementMatchers = [],
                    ...
                    if (!cached) {
                        ...
                        cached =
                            compilerCache(selector, matcherFromGroupMatchers(
        ...
        if (document.querySelectorAll) {
            (function () {
                var disconnectedMatch,
                    ...
                    // qSa(:focus) reports false when true (Chrome 21), no need
                    // to also add to buggyMatches since matches checks
                    // buggyQSA A support test would require too much code
                    // (would include document ready)
                    rbuggyQSA = [":focus"],

                    // matchesSelector(:active) reports false when true
                    // (IE9/Opera 11.5) A support test would require too much
                    // code (would include document ready) just skip
                    // matchesSelector for :active
                ...
                assert(function (div) {
                    ...
                    // elements are still enabled) IE8 throws error here (do
                    // not put tests after this one)
                ...
                if (matches) {
                    ...
                    Sizzle.matchesSelector = function (elem, expr) {
                        ...
                        // rbuggyMatches always contains :active, so no need
                        ...
                        if (!isXML(elem) && !rbuggyMatches.test(expr)
                            ...
                            try {
                                ...
                                if (ret || disconnectedMatch ||
                                    ...
                                    // be in a document fragment in IE 9
    ...
    jQuery.fn.extend({
                             ...
                             return !!selector && (
                                 typeof selector === "string"
                                     ? // If this is a positional/relative
                                       ...
                                       // returned set
                                     // so $("p:first").is("p:last") won't
                                     // return true for a doc with two "p".
                         ...
                         closest: function (selectors, context) {
                             ...
                             for (; i < l; i++) {
                                 ...
                                 while (cur && cur.ownerDocument && cur
                                                                    !== context
                                        && cur.nodeType !== 11) {
                         ...
                         add: function (selector, context) {
                             var set = typeof selector === "string" ? jQuery(
                                 selector, context) : jQuery.makeArray(
                                 selector && selector.nodeType ? [selector]
                                     : selector),
                                 all = jQuery.merge(this.get(), set);

                             return this.pushStack(
                                 isDisconnected(set[0]) || isDisconnected(
                                     all[0]) ? all : jQuery.unique(all));
                         },
...
// from a document (should be improved, where feasible).
    ...
    jQuery.each({
        ...
        jQuery.fn[name] = function (until, selector) {
            ...
            ret =
                this.length > 1 && !guaranteedUnique[name] ? jQuery.unique(ret)
                    : ret;
...
// unless wrapped in a div with non-breaking characters in front of it.
    ...
    jQuery.fn.extend({
                         ...
                         replaceWith: function (value) {
                             if (!isDisconnected(this[0])) {
                                 // Make sure that the elements are removed
                                 // from the DOM before they are inserted this
                                 // can help fix replacing a parent with child
                                 // elements
                                 if (jQuery.isFunction(value)) {
                                     return this.each(function (i) {
                                         var self = jQuery(this),
                             ...
                             return this.length ? this.pushStack(jQuery(
                                 jQuery.isFunction(value) ? value() : value),
                                                                 "replaceWith",
                                                                 value) : this;
                         },
                         ...
                         domManip: function (args, table, callback) {
                             ...
                             if (!jQuery.support.checkClone && l > 1
                                 && typeof value === "string" && rchecked.test(
                                     value)) {
                                 return this.each(function () {
                                     jQuery(this)
                             ...
                             if (jQuery.isFunction(value)) {
                                 return this.each(function (i) {
                                     var self = jQuery(this);
                                     args[0] =
                                         value.call(this, i, table ? self.html()
                                             : undefined);
    ...
    jQuery.buildFragment = function (args, context, scripts) {
        ...
        // collection or a node Updated to fix #12266 where accessing
        // context[0] could throw an exception in IE9/10 & also doubles as fix
        // for #8950 where plain objects caused createDocumentFragment
        // exception
        context = context || document;
        ...
        // the main document Cloning options loses the selected state, so don't
        // cache them IE 6 doesn't like it when you put <object> or <embed>
        // elements in a fragment Also, WebKit does not clone 'checked'
        // attributes on cloneNode, so don't cache Lastly, IE6,7,8 will not
        // correctly reuse cached fragments that were created from unknown
        // elems #10501
    ...
    jQuery.extend({
                      clone: function (elem, dataAndEvents, deepDataAndEvents) {
                          ...
                          if ((!jQuery.support.noCloneEvent
                              ...
                              // original. In order to get around this, we use
                              // some proprietary methods to clear the events.
                              // Thanks to MooTools guys for this hotness.
                              ...
                              // length property with an element if you are
                              // cloning the body and one of the elements on
                              // the page has a name or id of "length"
                      ...
                      clean: function (elems, context, fragment, scripts) {
                          ...
                          if (!jQuery.support.appendChecked) {
                              for (i = 0; (elem = ret[i]) != null; i++) {
                                  ...
                                  } else if (typeof elem.getElementsByTagName
                                             !== "undefined") {
                                      jQuery.grep(
                          ...
                          if (fragment) {
                              ...
                              handleScript = function (elem) {
                                  ...
                                  if (!elem.type || rscriptType.test(
                                      ...
                                      // fragment Return truthy to indicate
...
// return a css property mapped to a potentially vendor prefixed property
    ...
    jQuery.fn.extend({
                         ...
                         toggle: function (state, fn2) {
                             ...
                             if (jQuery.isFunction(state) && jQuery.isFunction(
                                     fn2)) {
                      ...
                      style: function (elem, name, value, extra) {
                          ...
                          if (value !== undefined) {
                              ...
                              if (!hooks || !("set" in hooks) || (value =
                                  ...
                                  // when 'invalid' values are provided Fixes
                                  // bug #5509
                                  try {
                                      style[name] = value;
                                  } catch (e) {
...
// Try to determine the default display value of an element
    function css_defaultDisplay(nodeName) {
        ...
        if (display === "none" || display === "") {
            ...
            // re-writing the fake HTML document to it; WebKit & Firefox won't
            // allow reusing the iframe document.
...
// for it is not run until after DOM ready
    jQuery(function () {
        if (!jQuery.support.reliableMarginRight) {
            jQuery.cssHooks.marginRight = {
                get: function (elem, computed) {
                    ...
                    // for margin-right Work around by temporarily setting
        ...
        // offset module, we just check for it here
...
// These hooks are used by animate to expand properties
    ...
    jQuery.fn.extend({
                         ...
                         serializeArray: function () {
                             return this.map(function () {
                                 return this.elements ? jQuery.makeArray(
                                     this.elements) : this;
                             })
                                 .filter(function () {
                                     return this.name && !this.disabled &&
                                            ( this.checked
                                              || rselectTextarea.test(
                                                    this.nodeName) ||
        ...
        if (jQuery.isArray(obj)) {
            ...
            jQuery.each(obj, function (i, v) {
                if (traditional || rbracket.test(prefix)) {
                    ...
                    // deserialize nested arrays properly, and attempting to do
                    // so may cause a server error. Possible fixes are to
                    // modify rack's deserialization algorithm or to provide an
                    // option or flag to force array serialization to be
                    // shallow.
            ...
            if (typeof selection === "string") {
                if (!executeOnly || inspected[selection]) {
                    ...
                    selection = inspectPrefiltersOrTransports(
                        structure, options, originalOptions, jqXHR, selection,
                        inspected);
                }
            }
        }
    ...
    jQuery.fn.load = function (url, params, callback) {
        ...
        jQuery.ajax({
            ...
            self.html(selector ? // Create a dummy div to hold the results
                      ...
                      // scripts to avoid any 'Permission Denied' errors in IE
...
// Attach a bunch of functions for handling common AJAX events
    ...
    jQuery.extend({
		...
		*/
                          ...
                          // single space in-between) 2) the catchall symbol
                      ...
                      ajax: function (url, options) {
                          ...
                          var // ifModified key
                              ...
                              // It's the callbackContext if one was provided
                              // in the options and if it's a DOM node or a
                              // jQuery collection
                          ...
                          // is declared at the end of the function (which
                          // would be more logical and readable)
                          ...
                          // with protocol-less urls) We also use the url
...
// Detect, normalize options and install callbacks for jsonp requests
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        ...
        var callbackName, overwritten, responseContainer,
            ...
            replaceInData = hasCallback && !replaceInUrl && typeof data
                            === "string" &&
        ...
        if (s.crossDomain) {
            ...
            return {
                ...
                send: function (_, callback) {
                    ...
                    // an IE6 bug. This arises when a base node is used (#2709
                    // and #4378).
            ...
            if (!s.crossDomain || jQuery.support.cors) {
                ...
                return {
                    send: function (headers, complete) {
                        ...
                        // Opera (#2865)
                        if (s.username) {
                            xhr.open(s.type, s.url, s.async, s.username,
                                     s.password);
                        } else {
                        ...
                        callback = function (_, isAbort) {
                            ...
                            // properties of an xhr when a network error
                            // occurred
                            ...
                            try {
                                ...
                                if (callback && ( isAbort || xhr.readyState
                                    ...
                                    if (isAbort) {
                                        ...
                                        // will throw an exception on any
                                        // attempt to access responseText
                                        // (#11426)
                                        try {
                                        ...
                                        // data: assume a success (success with
                                        // no data won't get notified, that's
                                        // the best we can do given current
                                        // implementations)
                                        if (!status && s.isLocal
                                            && !s.crossDomain) {
                        ...
                        if (!s.async) {
                            ...
                            if (xhrOnUnloadAbort) {
                                ...
                                // needed and attach the unload handler
                                if (!xhrCallbacks) {
                                    xhrCallbacks = {};
            ...
            "*": [function (prop, value) {
                ...
                if (parts) {
                    ...
                    if (unit !== "px" && start) {
                        ...
                        // will be trivial if it uses the same units Fallback
                        // to end or a simple constant
                        start = jQuery.css(tween.elem, prop, true) || end || 1;

                        do {
                            // If previous iteration zeroed out, double until
                            // we get *something* Use a string for doubling
                            // factor so we don't accidentally see scale as
                            // unchanged below
                            scale = scale || ".5";
                            ...
                            // tween.cur() And breaking the loop if scale is
                            // unchanged or perfect, or if we've just had
                            // enough
        ...
        jQuery.fn[name] = function (speed, easing, callback) {
            return speed == null || typeof speed === "boolean" ||
                   ...
                   ( !i && jQuery.isFunction(speed) && jQuery.isFunction(
                       easing) ) ? cssFn.apply(this, arguments) : this.animate(
...
// Back Compat <1.8 extension point
    ...
    jQuery.fn.extend({
                         ...
                         position: function () {
                             ...
                             offset.left -=
                                 parseFloat(jQuery.css(elem, "marginLeft"))
                                 || 0;

                             // Add offsetParent borders
                             parentOffset.top +=
                                 parseFloat(jQuery.css(offsetParent[0],
                                                       "borderTopWidth")) || 0;
                             parentOffset.left +=
                                 parseFloat(jQuery.css(offsetParent[0],
                                                       "borderLeftWidth")) || 0;
                         ...
                         offsetParent: function () {
                             return this.map(function () {
                                 var offsetParent = this.offsetParent
                                                    || document.body;
                                 while (offsetParent && (!rroot.test(
                                     offsetParent.nodeName) && jQuery.css(
