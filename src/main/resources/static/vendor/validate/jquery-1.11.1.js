...
(function (global, factory) {
    ...
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        // present, execute the factory and get jQuery For environments that do
        // not inherently posses a window with a document (such as Node.js),
        // expose a jQuery-making factory as module.exports This accentuates
        // the need for the creation of a real window e.g. var jQuery =
        // require("jquery")(window); See ticket #14549 for more info
        module.exports =
...
//
    ...
    jQuery.extend({
                      ...
                      expando: "jQuery" + ( version + Math.random() ).replace(
                          /\D/g, ""),
                      ...
                      // isFunction. Since version 1.3, DOM methods and
                      // functions like alert aren't supported. They return
                      // false on IE (#2968).
                      ...
                      isNumeric: function (obj) {
                          ...
                          // (null|true|false|"") ...but misinterprets
                          // leading-number strings, particularly hex literals
                      ...
                      isPlainObject: function (obj) {
                          ...
                          // of the constructor property. Make sure that DOM
                          // nodes and window objects don't pass through, as
                          // well
                          ...
                          // up, if last one is own, then all properties are
                          // own.
                          for (key in obj) {
                          }
                      ...
                      globalEval: function (data) {
                          if (data && jQuery.trim(data)) {
                              ...
                              // is window rather than jQuery in Firefox
                      ...
                      // modules Microsoft forgot to hump their vendor prefix
                      // (#9572)
                      ...
                      proxy: function (fn, context) {
                          ...
                          // the spec this throws a TypeError, but we will just
                          // return undefined.
                      ...
                      // attach their properties to it so it needs to exist.
                      support: support
                  });
        ...
        (function (window) {
            ...
            var i,
                ...
                pseudos = ":(" + characterEncoding + ")(?:\\((" +
                          // To reduce the number of selectors needing tokenize
                          // in the preFilter, prefer arguments: 1. quoted
                          // (capture 3; capture 4 or capture 5)
                          "('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|"
                          +
                          // 2. simple (capture 6)
                          "((?:\\\\.|[^\\\\()[\\]]|" + attributes + ")*)|" +
...
// Optimize for push.apply( _, NodeList )
            ...
            function Sizzle(selector, context, results, seed) {
                ...
                if (documentIsHTML && !seed) {
                    ...
                    if ((match = rquickExpr.exec(selector))) {
                        ...
                        if ((m = match[1])) {
                            if (nodeType === 9) {
                                ...
                                // 4.6 returns nodes that are no longer in the
                                // document (jQuery #6963)
                                if (elem && elem.parentNode) {
                                    // Handle the case where IE, Opera, and
                                    // Webkit return items by name instead of
                                    // ID
                                    if (elem.id === m) {
                                        results.push(elem);
                                        return results;
                    ...
                    // QSA path
                    if (support.qsa && (!rbuggyQSA || !rbuggyQSA.test(
                            selector))) {
                        nid = old = expando;
                        newContext = context;
                        ...
                        // the root and working up from there (Thanks to Andrew
                        // Dupont for the technique) IE 8 doesn't work on
                        // object elements
                        if (nodeType === 1 && context.nodeName.toLowerCase()
                            ...
                            newContext =
                                rsibling.test(selector) && testContext(
             ...
             * @returns {Function(string, Object)} Returns the Object data
             *     after storing it on itself with property name the
             *     (space-suffixed) string and (if the cache is larger than
             ...
             * @param {Function} fn Passed the created div and expects a
             *     boolean result
             */
            function assert(fn) {
             ...
             * @param {Element} a
             * @param {Element} b
             * @returns {Number} Returns less than 0 if a precedes b, greater
...
// Expose support vars for convenience
            ...
            isXML = Sizzle.isXML = function (elem) {
                ...
                // exist (such as loading iframes in IE - #4833)
            ...
            /**
             * Sets document-related variables once based on the current
             * document
             * @param {Element|Object} [doc] An element or document object to
            ...
            setDocument = Sizzle.setDocument = function (node) {
                ...
                // iframe has been reloaded, IE will throw "permission denied"
                // error when accessing "document" variable, see jQuery #13936
                // IE6-8 do not support the defaultView property so parent will
                // be undefined
	...
	---------------------------------------------------------------------- */
                ...
                support.getElementsByClassName =
                    rnative.test(doc.getElementsByClassName) && assert(
                    function (div) {
                        div.innerHTML =
                ...
                // programatically-set names, so use a roundabout
                ...
                if (support.getById) {
                    Expr.find["ID"] = function (id, context) {
                        if (typeof context.getElementById !== strundefined
                            ...
                            // returns nodes that are no longer in the document
                            // #6963
                ...
                // Class
                Expr.find["CLASS"] =
                    support.getElementsByClassName && function (className,
                                                                context) {
	...
	---------------------------------------------------------------------- */
                ...
                // So, we allow :focus to pass through QSA all the time to
                // avoid the IE error See http://bugs.jquery.com/ticket/13378
                rbuggyQSA = [];
                ...
                if ((support.qsa = rnative.test(doc.querySelectorAll))) {
                    ...
                    assert(function (div) {
                        ...
                        // ^= or $= or *= The test attribute must be unknown in
                    ...
                    assert(function (div) {
                        ...
                        // (hidden elements are still enabled) IE8 throws error
                ...
                if ((support.matchesSelector =
                        rnative.test((matches = docElem.matches ||
	...
	---------------------------------------------------------------------- */
                ...
                contains =
                    hasCompare || rnative.test(docElem.contains) ? function (a,
                                                                             b) {
	...
	---------------------------------------------------------------------- */
                ...
                sortOrder = hasCompare ? function (a, b) {
                    ...
                    // Calculate position if both inputs belong to the same
                    // document
                    compare =
                    ...
                    if (compare & 1 ||
                        ...
                        return sortInput ? ( indexOf.call(sortInput, a)
                                             - indexOf.call(sortInput, b) ) : 0;
                    }
                    ...
                    if (!aup || !bup) {
                        return a === doc ? -1 : b === doc ? 1 : aup ? -1 : bup
                            ? 1 : sortInput ? ( indexOf.call(sortInput, a)
                    ...
                    return i
                        ...
                        : // Otherwise nodes in our document sort first
                           ap[i] === preferredDoc ? -1 : bp[i] === preferredDoc
                               ? 1 : 0;
                };
            ...
            Sizzle.uniqueSort = function (results) {
                ...
                // Unless we *know* we can detect duplicates, assume their
                // presence
			...
			*/
                        ...
                        if (match[1].slice(0, 3) === "nth") {
                            ...
                            match[4] =
                                +( match[4] ? match[5] + (match[6] || 1) : 2
                                                                           * ( match[3]
                                                                               === "even"
                                                                               || match[3]
                                                                               === "odd" ) );
                            match[5] =
                                +( ( match[7] + match[8] ) || match[3]
                                   === "odd" );
                    ...
                    "PSEUDO": function (match) {
                        ...
                        if (match[3]) {
                            ...
                            // Strip excess characters from unquoted arguments
                                   ...
                                   (excess =
                                       unquoted.indexOf(")", unquoted.length
                ...
                filter: {
                    ...
                    "PSEUDO": function (pseudo, argument) {
                        ...
                        // pseudos are added with uppercase letters Remember
                        // that setFilters inherits from pseudos
                        var args,
                        ...
                        if (fn.length > 1) {
                            ...
                            return Expr.setFilters.hasOwnProperty(
                                pseudo.toLowerCase()) ? markFunction(
                ...
                pseudos: {
                    ...
                    // or beginning with the identifier C immediately followed
                    // by "-". The matching of C against the element's language
                    // value is performed case-insensitively. The identifier C
                    // does not have to be a valid language name."
                    ...
                    "empty": function (elem) {
                        ...
                        // (text: 3; cdata: 4; entity ref: 5), but not by
                        // others (comment: 8; processing instruction: 7; etc.)
...
// Easy API for creating new setFilters
                    ...
                    if (seed) {
                        if (postFinder || preFilter) {
                            ...
                            while (i--) {
                                if ((elem = matcherOut[i]) &&
                                    (temp =
                                        postFinder ? indexOf.call(seed, elem)
                                            : preMap[i]) > -1) {
                        ...
                        matcherOut = condense(
                            matcherOut === results ? matcherOut.splice(
                                preexisting, matcherOut.length) : matcherOut
                        );
                        if (postFinder) {
            ...
            function matcherFromTokens(tokens) {
                ...
                for (; i < len; i++) {
                    if ((matcher = Expr.relative[tokens[i].type])) {
                        ...
                        matcher =
                            Expr.filter[tokens[i].type].apply(null,
                                                              tokens[i].matches);
                    ...
                    superMatcher = function (seed, context, xml, results,
                        ...
                        var elem, j, matcher,
                            ...
                            dirrunsUnique = (dirruns +=
                                contextBackup == null ? 1 : Math.random()
                                                            || 0.1),
                            len = elems.length;
                        ...
                        // results Keep `i` a string if there are no elements
                        // so `matchedCount` will be "00" below Support: IE<9,
                        // Safari Tolerate NodeList properties (IE: "length";
            ...
            compile =
                Sizzle.compile =
                    function (selector, match /* Internal Use Only */) {
                        var i,
                            setMatchers = [],
                            elementMatchers = [],
                        ...
                        if (!cached) {
                            // Generate a function of recursive functions that
                            // can be used to check each element
                            if (!match) {
            ...
            select =
                Sizzle.select = function (selector, context, results, seed) {
                    ...
                    // Try to minimize operations if there is no seed and only
                    // one group
                    if (match.length === 1) {
                        ...
                        if (tokens.length > 2 && (token = tokens[0]).type
                            ...
                            if (!context) {
                                ...
                                // Precompiled matchers will still verify
                                // ancestry, so step up a level
                            } else if (compiled) {
                                context = context.parentNode;
                            }

                            selector =
                                selector.slice(tokens.shift().value.length);
                        }

                        // Fetch a seed set for right-to-left matching
                        i =
                            matchExpr["needsContext"].test(selector) ? 0
                                : tokens.length;
                        while (i--) {
                            token = tokens[i];
                            ...
                            if ((find = Expr.find[type])) {
                                ...
                                if ((seed = find(
                                    ...
                                    // If seed is empty or no tokens remain, we
                                    // can return early
                                    tokens.splice(i, 1);
                                    selector =
                    ...
                    // provided Provide `match` to avoid retokenization if we
    ...
    jQuery.fn.extend({
                         ...
                         is: function (selector) {
                             return !!winnow(
                                 ...
                                 // If this is a positional/relative selector,
                                 // check membership in the returned set so
                                 // $("p:first").is("p:last") won't return true
...
// Initialize central reference
    ...
    jQuery.extend({
                      dir: function (elem, dir, until) {
                          ...
                          while (cur && cur.nodeType !== 9 && (until
                                                               === undefined
                                                               || cur.nodeType
                                                               !== 1 || !jQuery(
                                  cur).is(until))) {
    ...
    jQuery.fn.extend({
                         ...
                         closest: function (selectors, context) {
                             var cur,
                                 ...
                                 l = this.length,
                                 matched = [],
                                 pos = rneedsContext.test(selectors)
                             ...
                             for (; i < l; i++) {
                                 for (cur = this[i]; cur && cur !== context;
                                     ...
                                     if (cur.nodeType < 11 && (pos ? pos.index(
                                             cur) > -1
                             ...
                             return this.pushStack(
                                 matched.length > 1 ? jQuery.unique(matched)
                                     : matched);
                         },
 ...
 */
    jQuery.Callbacks = function (options) {
        ...
        options =
            typeof options === "string" ? ( optionsCache[options]
    ...
    jQuery.extend({
                      ...
                      when: function (subordinate /* , ..., subordinateN */) {
                          var i = 0,
                              ...
                              // the master Deferred. If resolveValues consist
                              // of only a single Deferred, just use that.
...
// The deferred used on DOM ready
    ...
    jQuery.ready.promise = function (obj) {
        if (!readyList) {
            ...
            // browser event has already occurred. we once tried to use
            // readyState "interactive" here, but it caused issues like the one
    ...
    jQuery(function () {
        ...
        if (typeof div.style.zoom !== strundefined) {
            ...
            if (val) {
                ...
                // #11048 Prevent IE from shrinking the body in IE 7 mode
                // #12869 Support: IE<8
                body.style.zoom = 1;
            }
        }
                ...
                try {
                    data =
                        data === "true" ? true : data === "false" ? false : data
                                                                            === "null"
                            ? null
                            : // Only convert to a number if it doesn't change
                              // the string
                                                                            +data
                                                                            + ""
                                                                            === data
...
// checks a cache object for emptiness
    ...
    function internalData(elem, name, data, pvt /* Internal Use Only */) {
        ...
        var ret, thisCache,
            ...
            // allows the code to shortcut on the same path as a DOM node with
            // no cache
            id = isNode ? elem[internalKey] : elem[internalKey] && internalKey;

        // Avoid doing any more work than we need to when trying to get data on
        // an object that has no data at all
        ...
        // internal data cache in order to avoid key collisions between
        ...
        // names If a data property was specified
        ...
        if (name) {
            ...
            if (thisCache) {
                ...
                if (!jQuery.isArray(name)) {
                    ...
                    // signature, keys will be converted to camelCase. Since
                    // there is no way to tell _how_ a key was added, remove
                    // both plain key and camelCase key. #12786 This will only
                    // penalize the array argument path.
    ...
    jQuery.extend({
                      ...
                      // The following elements (space-suffixed to avoid
                      // Object.prototype collisions) throw uncatchable
                      // exceptions if you attempt to set expando properties
                      noData: {
                          "applet ": true,
                          "embed ": true,
                          // ...but Flash objects (which have this classid)
                          // *can* handle expandos
    ...
    jQuery.fn.extend({
                         data: function (key, value) {
                             ...
                             // Special expections of .data basically thwart
                             // jQuery.access, so implement the relevant
                             // behavior ourselves
    ...
    jQuery.extend({
                      ...
                      dequeue: function (elem, type) {
                          ...
                          if (fn) {
                              ...
                              // queue from being automatically dequeued
                              if (type === "fx") {
                      ...
                      _queueHooks: function (elem, type) {
                          ...
                          return jQuery._data(elem, key) || jQuery._data(elem,
                                                                         key, {
    ...
    jQuery.fn.extend({
                         queue: function (type, data) {
                             ...
                             return data === undefined ? this : this.each(
                                 function () {
...
// The value/s can optionally be executed if it's a function
    ...
    (function () {
        ...
        // undefined). IE9-10 clones events bound via attachEvent, but they
 ...
 */
    jQuery.event = {
        ...
        add: function (elem, types, handler, data, selector) {
            ...
            if (!(eventHandle = elemData.handle)) {
                eventHandle = elemData.handle = function (e) {
                    ...
                    return typeof jQuery !== strundefined && (!e
            ...
            while (t--) {
                ...
                // If event changes its type, use the special event handlers
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
            ...
            while (t--) {
                ...
                // more handlers exist (avoids potential for endless recursion
            ...
            if (jQuery.isEmptyObject(events)) {
                ...
                // if empty so use it instead of delete
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            // event type string
            event =
                event[jQuery.expando] ? event : new jQuery.Event(
            ...
            // (#9951) Bubble up to document, then to window; watch for a
            // global ownerDocument var (#9724)
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(
                    ...
                    // name name as the event. Can't use an .isFunction() check
                    // here because IE6/7 fails that test. Don't do default
                    // actions on window, that's where global variables be
                    // (#6170)
                    if (ontype && elem[type] && !jQuery.isWindow(elem)) {
                        ...
                        try {
                            ...
                            // (#1486,#12518) only reproducible on winXP IE8
        ...
        dispatch: function (event) {
            ...
            // Call the preDispatch hook for the mapped type, and let it bail
            // if desired
                    ...
                    if (cur.nodeType === 1 && (cur.disabled !== true
                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (matches[sel] === undefined) {
                                matches[sel] =
                                    handleObj.needsContext ? jQuery(sel, this)
                                                                 .index(cur)
                                                             >= 0 : jQuery.find(
        ...
        fix: function (event) {
            ...
            if (!fixHook) {
                this.fixHooks[type] = fixHook =
                    rmouseEvent.test(type) ? this.mouseHooks : rkeyEvent.test(
                        type) ? this.keyHooks : {};
            }
            copy =
                fixHook.props ? this.props.concat(fixHook.props) : this.props;
        ...
        keyHooks: {
            ...
            filter: function (event, original) {
                ...
                if (event.which == null) {
                    event.which =
                        original.charCode != null ? original.charCode
                            : original.keyCode;
                }
        ...
        mouseHooks: {
            ...
            filter: function (event, original) {
                ...
                if (!event.which && button !== undefined) {
                    event.which =
                        ( button & 1 ? 1 : ( button & 2 ? 3 : ( button & 4 ? 2
                            : 0 ) ) );
                }
                ...
                trigger: function () {
                    if (this !== safeActiveElement() && this.focus) {
                        try {
                            ...
                            // #12518), let .trigger() run the handlers
                        }
                    }
                },
    ...
    jQuery.removeEvent =
        document.removeEventListener ? function (elem, type, handle) {
            ...
            if (elem.detachEvent) {
                ...
                // IE6-8 detachEvent needed property on element, by name of
    ...
    jQuery.each({
        ...
        jQuery.event.special[orig] = {
            ...
            handle: function (event) {
                ...
                // the target. NB: No relatedTarget if the mouse left/entered
                // the browser window
        ...
        jQuery.event.special.change = {
            ...
            setup: function () {
                ...
                if (rformElems.test(this.nodeName)) {
                    ...
                    // trigger it on click after a propertychange. Eat the
                    // blur-change in special.change.handle. This still fires
...
// Create "bubbling" focus and blur events
    ...
    var nodeNames = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|"
        ...
        wrapMap = {
            ...
            // IE6-8 can't serialize link, script, style, or any html5
            // (NoScope) tags, unless wrapped in a div with non-breaking
...
// Manipulating tables requires a tbody
    function manipulationTarget(elem, content) {
        return jQuery.nodeName(elem, "table") &&
               jQuery.nodeName(
                   content.nodeType !== 11 ? content : content.firstChild, "tr")
...
// Mark scripts as having already been evaluated
    ...
    function fixCloneNodeIssues(src, dest) {
        ...
        if (nodeName === "script" && dest.text !== src.text) {
            ...
            // classid. IE10 throws NoModificationAllowedError if parent is
            // null, #12132.
    ...
    jQuery.extend({
                      clone: function (elem, dataAndEvents, deepDataAndEvents) {
                          ...
                          if (destElements.length > 0) {
                              setGlobalEval(destElements, !inPage && getAll(
                                  elem, "script"));
                          }
                      ...
                      buildFragment: function (elems, context, scripts,
                          ...
                          for (; i < l; i++) {
                              ...
                              if (elem || elem === 0) {
                                  ...
                                  if (jQuery.type(elem) === "object") {
                                      ...
                                      // Manually add leading whitespace
                                      // removed by IE
                          ...
                          while ((elem = nodes[i++])) {
                              ...
                              // #4087 - If origin and destination elements are
                              // the same, and this is that element, do not do
                              // anything
                          ...
                          for (; (elem = elems[i]) != null; i++) {
                              if (acceptData || jQuery.acceptData(elem)) {
                                  ...
                                  if (data) {
                                      ...
                                      // already removed by jQuery.event.remove
                                      if (cache[id]) {

                                          delete cache[id];

                                          // IE does not allow us to delete
                                          // expando properties from nodes, nor
                                          // does it have a removeAttribute
                                          // function on Document nodes; we
    ...
    jQuery.fn.extend({
                         ...
                         remove: function (selector, keepData
                                           /* Internal Use Only */) {
                             var elem,
                                 elems = selector ? jQuery.filter(selector,
                                                                  this) : this,
                                 i = 0;
                         ...
                         empty: function () {
                             ...
                             for (; (elem = this[i]) != null; i++) {
                                 ...
                                 // displays empty (#12336) Support: IE<9
                                 if (elem.options && jQuery.nodeName(elem,
                                                                     "select")) {
                         ...
                         clone: function (dataAndEvents, deepDataAndEvents) {
                             ...
                             deepDataAndEvents =
                                 deepDataAndEvents == null ? dataAndEvents
                                     : deepDataAndEvents;
                             ...
                             return access(this, function (value) {
                                 ...
                                 if (typeof value === "string"
                                     ...
                                     try {
                                         ...
                                         // exception, use the fallback method
                                     } catch (e) {
                                     }
                                 }
                         ...
                         domManip: function (args, callback) {
                             ...
                             if (l) {
                                 ...
                                 if (first) {
                                     scripts =
                                         jQuery.map(getAll(fragment, "script"),
                                                    disableScript);
                                     hasScripts = scripts.length;

                                     // Use the original fragment for the last
                                     // item instead of the first because it
                                     // can end up being emptied incorrectly in
                                     ...
                                     if (hasScripts) {
                                         ...
                                         // Evaluate executable scripts on
...
// Called only from within defaultDisplay
    function actualDisplay(name, doc) {
        var style,
            ...
            display = window.getDefaultComputedStyle && ( style =
                ...
                // since it was removed from specification and supported only
                // in FF
    ...
    if (window.getComputedStyle) {
        ...
        curCSS = function (elem, name, computed) {
            ...
            // #12537
            ret =
                computed ? computed.getPropertyValue(name) || computed[name]
                    : undefined;
            ...
            if (computed) {
                ...
                // "used value" for margin-right Safari 5.1.7 (at least)
                // returns percentage for a larger set of values, but width
                // seems to be reliably pixels this is against the CSSOM draft
        ...
        curCSS = function (elem, name, computed) {
            ...
            // pixels but not position css attributes, as those are
            // proportional to the parent element instead and we can't measure
            // the parent instead because it might trigger a "stacking dolls"
            // problem
    ...
    function addGetHookIf(conditionFn, hookFn) {
        ...
        return {
            get: function () {
                ...
                if (condition == null) {
                    // The test was not ready at this point; screw the hook
                    // this time but check again when needed next time.
                    return;
                }

                if (condition) {
                    // Hook not needed (or it's not possible to use it due to
                    // missing dependency), remove it. Since there are no other
                    // hooks for marginRight, remove the whole object.
                    delete this.get;
                    return;
                }
    ...
    (function () {
        ...
        // Vendor-prefix box-sizing
        support.boxSizing =
            style.boxSizing === "" || style.MozBoxSizing === "" ||
        ...
        function computeStyleTests() {
            ...
            if (window.getComputedStyle) {
                ...
                // (#3333) WebKit Bug 13343 - getComputedStyle returns wrong
            ...
            // set to display:none and there are still other visible table
            // cells in a table row; if so, offsetWidth/Height are not reliable
            // for use when determining if an element has been hidden directly
            // using display:none (it is still safe to use offsets if a parent
            // element is hidden; don safety goggles and see bug #4512 for more
            // information).
...
// return a css property mapped to a potentially vendor prefixed property
    ...
    function augmentWidthOrHeight(elem, name, extra, isBorderBox, styles) {
        ...
        for (; i < 4; i += 2) {
            ...
            if (isBorderBox) {
                ...
                if (extra === "content") {
                    val -=
                        jQuery.css(elem, "padding" + cssExpand[i], true,
                                   styles);
                }
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        var valueIsBorderBox = true,
            ...
            isBorderBox = support.boxSizing && jQuery.css(elem, "boxSizing",
                                                          false, styles)
                          === "border-box";

        // some non-html elements return undefined for offsetWidth, so check
        // for null/undefined svg -
        ...
        if (val <= 0 || val == null) {
            ...
            // unreliable values for getComputedStyle silently falls back to
            // the reliable elem.style
            valueIsBorderBox =
                isBorderBox && ( support.boxSizingReliable() || val
                                 === elem.style[name] );
    ...
    jQuery.extend({
                      ...
                      style: function (elem, name, value, extra) {
                          ...
                          if (value !== undefined) {
                              ...
                              // specifing setters in cssHooks, but it would
                              // mean to define eight (for every problematic
        ...
        jQuery.cssHooks[name] = {
            get: function (elem, computed, extra) {
                if (computed) {
                    ...
                    // show them however, it must have a current display style
                    // that would benefit from this
                    return rdisplayswap.test(jQuery.css(elem, "display"))
                           && elem.offsetWidth === 0 ? jQuery.swap(elem,
                                                                   cssShow,
                                                                   function () {
            ...
            set: function (elem, value, extra) {
                ...
                return setPositiveNumber(elem, value,
                                         extra ? augmentWidthOrHeight(
                                             elem,
                                             name,
                                             extra,
                                             support.boxSizing && jQuery.css(
                                             elem, "boxSizing", false, styles)
                                             === "border-box",
                                             styles
                                         ) : 0
                );
        ...
        jQuery.cssHooks.opacity = {
            ...
            set: function (elem, value) {
                var style = elem.style,
                    ...
                    opacity = jQuery.isNumeric(value) ? "alpha(opacity=" + value
                                                        * 100 + ")" : "",
                ...
                // attempt to remove filter attribute #6652 if value === "",
                // then remove inline opacity #12685
                if (( value >= 1 || value === "" ) &&
                    ...
                    // clearType is disabled, we want to avoid this
        ...
        _default: {
            get: function (tween) {
                ...
                if (tween.elem[tween.prop] != null &&
                    (!tween.elem.style || tween.elem.style[tween.prop]
                     == null)) {
                    return tween.elem[tween.prop];
                }

                // passing an empty string as a 3rd parameter to .css will
                // automatically attempt a parseFloat and fallback to a string
                // if the parse fails so, simple values such as "10px" are
                // parsed to Float. complex values such as "rotate(1rad)" are
                // returned as is.
            ...
            set: function (tween) {
                ...
                // use .style if its available and use plain properties where
                // available
            ...
            "*": [function (prop, value) {
                ...
                if (start && start[3] !== unit) {
                    ...
                    do {
                        ...
                        // get *something* Use a string for doubling factor so
                ...
                if (parts) {
                    ...
                    // animation
                    tween.end =
                        parts[1] ? start + ( parts[1] + 1 ) * parts[2]
                            : +parts[2];
                }
...
// Generate parameters to create a standard animation
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (elem.nodeType === 1 && ( "height" in props || "width" in props )) {
            ...
            checkDisplay =
                display === "none" ? jQuery._data(elem, "olddisplay")
    ...
    function Animation(elem, properties, options) {
            ...
            animation = deferred.promise({
                                             ...
                                             stop: function (gotoEnd) {
                                                 var index = 0,
                                                     ...
                                                     // end, we want to run all
                                                     // the tweens otherwise we
                                                     // skip this part
                                                     length = gotoEnd
        ...
        for (; index < length; index++) {
            result =
                animationPrefilters[index].call(animation, elem, props,
                                                animation.opts);
            if (result) {
                return result;
            }
    ...
    jQuery.fn.extend({
                         fadeTo: function (speed, to, easing, callback) {
                             ...
                             // show any hidden elements after setting opacity
                             // to 0
                         ...
                         animate: function (prop, speed, easing, callback) {
                             ...
                             return empty || optall.queue === false ? this.each(
                                 doAnimation) : this.queue(optall.queue,
                                                           doAnimation);
                         },
                         stop: function (type, clearQueue, gotoEnd) {
                             ...
                             return this.each(function () {
                                 ...
                                 // step wasn't forced timers currently will
                                 // call their complete callbacks, which will
                         ...
                         finish: function (type) {
                             ...
                             return this.each(function () {
                                 ...
                                 // look for any animations in the old queue
                                 // and finish them
                                 for (index = 0; index < length; index++) {
...
// http://blindsignals.com/index.php/2009/07/jquery-delay/
    ...
    (function () {
        ...
        // property. (WebKit defaults to false instead of true, IE too, if it's
        // in an optgroup)
        ...
        // disabled (WebKit marks them as disabled)
    ...
    jQuery.fn.extend({
                         val: function (value) {
                             ...
                             return this.each(function (i) {
                                 ...
                                 // normal setting
                                 if (!hooks || !("set" in hooks) || hooks.set(
                          ...
                          select: {
                              ...
                              set: function (elem, value) {
                                  ...
                                  while (i--) {
                                      ...
                                      if (jQuery.inArray(
                                              jQuery.valHooks.option.get(
                                                  option), values) >= 0) {

                                          // Support: IE6
                                          // When new option element is added
                                          // to select box we need to force
                                          // reflow of newly added node in
                                          // order to workaround delay of
                              ...
                              while ((name = attrNames[i++])) {
                                  ...
                                  if (jQuery.expr.match.bool.test(name)) {
                                      ...
                                      if (getSetInput && getSetAttribute
                                          ...
                                          // Support: IE<9
                                          // Also clear
                                          // defaultChecked/defaultSelected (if
                                          // appropriate)
                                      } else {
                                          elem[jQuery.camelCase("default-"
                                                                + name)] =
                                              elem[propName] = false;
                                      }
                          ...
                          type: {
                              set: function (elem, value) {
                                  if (!support.radioValue && value === "radio"
                                      ...
                                      // IE6-9 Reset value to default in case
                                      // type is set after value during
                                      // creation
                                      var val = elem.value;
    ...
    if (!support.style) {
        jQuery.attrHooks.style = {
            get: function (elem) {
                ...
                // .toLowerCase() .cssText, that would destroy case
                         ...
                         toggleClass: function (value, stateVal) {
                             ...
                             return this.each(function () {
                                 if (type === "string") {
                                     ...
                                     // we're passed "false", then remove the
                                     // whole classname (if there was one, the
                                     // above saved it). Otherwise bring back
                                     // whatever was previously saved (if
                                     // anything), falling back to the empty
                                     // string if nothing was stored.
                                     this.className =
...
// Return jQuery for attributes-only inclusion
    ...
    jQuery.parseJSON = function (data) {
        ...
        // that nothing remains after removing valid tokens
        return str && !jQuery.trim(
            str.replace(rvalidtokens, function (token, comma, open, close) {
                ...
                // Perform no more replacements after returning to outermost
                // depth
                if (depth === 0) {
                    return token;
                }
                ...
                // Determine new depth
                // array/object open ("[" or "{"): depth += true - false
                // (increment) array/object close ("]" or "}"): depth += false
                // - true (decrement) other cases ("," or primitive): depth +=
                // true - true (numeric cast)
                depth += !close - !open;
        ...
        while (current) {
            ...
            if (current) {
                ...
                if (current === "*") {
                    ...
                    conv =
                        converters[prev + " " + current] || converters["* "
                                                                       + current];
		...
		*/
                      ...
                      ajax: function (url, options) {
                          ...
                          var // Cross-domain detection vars
                              ...
                              // Context for global events is callbackContext
                              // if it is a DOM node or jQuery collection
                          ...
                          // with protocol-less urls) Handle falsy url in the
                          // settings object (#10093: consistency with old
                          // signature) We also use the url parameter if
                          // available
                          s.url =
                              ( ( url || s.url || ajaxLocation ) + "" ).replace(
                                  rhash, "")
                                  .replace(rprotocol, ajaxLocParts[1] + "//");

                          // Alias method option to type as per ticket #12004
                          s.type =
                              options.method || options.type || s.method
                              || s.type;

                          // Extract dataTypes list
                          s.dataTypes =
                              jQuery.trim(s.dataType || "*").toLowerCase()
                                  .match(rnotwhite) || [""];
                          ...
                          if (s.beforeSend && ( s.beforeSend.call(
                                  callbackContext, jqXHR, s) === false || state
                                                === 2 )) {
                          ...
                          // Get transport
                          transport =
                              inspectPrefiltersOrTransports(transports, s,
                                                            options, jqXHR);
                          ...
                          function done(status, nativeStatusText, responses,
                              ...
                              // collection (no matter how long the jqXHR
                              // object will be used)
                              transport = undefined;
...
// key/values into a query string
    ...
    jQuery.fn.extend({
                         ...
                         serializeArray: function () {
                             return this.map(function () {
                                 // Can add propHook for "elements" to filter
                                 // or add form elements
                                 var elements = jQuery.prop(this, "elements");
                                 return elements ? jQuery.makeArray(elements)
                                     : this;
                             })
                                 .filter(function () {
                                     var type = this.type;
                                 ...
                                 .map(function (i, elem) {
                                     ...
                                     return val == null ? null : jQuery.isArray(
                                         val) ? jQuery.map(val, function (val) {
                                         return {
                                             name: elem.name,
...
// (This is still attached to ajaxSettings for backward compatibility)
    jQuery.ajaxSettings.xhr =
        window.ActiveXObject !== undefined ? // Support: IE6+
        function () {
            ...
            if (!options.crossDomain || support.cors) {
                ...
                return {
                    send: function (headers, complete) {
                        ...
                        // For cross-domain requests, seeing as conditions for
                        // a preflight are akin to a jigsaw puzzle, we simply
                        // never set it to be sure. (it can always be set on a
                        // per-request basis or even using ajaxSetup) For
                        // same-domain requests, won't change header if already
                        // provided.
                        ...
                        for (i in headers) {
                            ...
                            // exception when setting request header to a
                            // null-value.  To keep consistent with other XHR
                            // implementations, cast the value to string and
                            // ignore `undefined`.
                        ...
                        callback = function (_, isAbort) {
                            ...
                            if (callback && ( isAbort || xhr.readyState
                                ...
                                if (isAbort) {
                                    ...
                                    // Support: IE<10
                                    // Accessing binary-data responseText
                                    // throws an exception (#11426)
                                    if (typeof xhr.responseText === "string") {
                                        responses.text = xhr.responseText;
                                    }

                                    // Firefox throws an exception when
                                    // accessing statusText for faulty
                                    ...
                                    // data: assume a success (success with no
                                    // data won't get notified, that's the best
                                    // we can do given current implementations)
        ...
        if (s.crossDomain) {
            ...
            return {
                ...
                send: function (_, callback) {
                    ...
                    // by prepending Use native DOM manipulation to avoid our
...
// context, defaults to document keepScripts (optional): If true, will include
...
// Keep a copy of the old load method
    ...
    jQuery.fn.extend({
                         offset: function (options) {
                             ...
                             // error BlackBerry 5, iOS 3 (original iPhone)
                         ...
                         position: function () {
                             ...
                             if (jQuery.css(elem, "position") === "fixed") {
                                 // we assume that getBoundingClientRect is
                                 // available when computed position is fixed
                             ...
                             // offsetLeft and marginLeft are the same in
                             // Safari causing offset.left to incorrectly be 0
                             return {
                ...
                jQuery.fn[funcName] = function (margin, value) {
                    ...
                    return access(this, function (elem, type, value) {
                        ...
                        if (jQuery.isWindow(elem)) {
                            // As of 5/8/2012 this will yield incorrect results
                            // for Mobile Safari, but there isn't a whole lot
                            // we can do. See pull request at this URL for
                            // discussion:
                        ...
                        if (elem.nodeType === 9) {
                            ...
                            // whichever is greatest unfortunately, this causes
                            // bug #3838 in IE6/8 only, but there is currently
